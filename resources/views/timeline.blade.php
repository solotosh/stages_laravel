    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{route('edit',$stage->id)}}" class="btn btn-sm btn-warning">Edit</a>

                    <form action="{{ route('destroy', $stage->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" onclick="return confirm('Are you sure you want to delete this stage?')" class="btn btn-sm">Delete</button>
                    </form>
